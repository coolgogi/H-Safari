                        ...
                        child: Form(
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text("이메일 주소 *", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold ),),
                                  SizedBox(height: 10),
                                  Container(
                                  ...
                                  //가격 입력하는 텍스트 필드
                                  Text("제목 * ", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold ),),
                                  SizedBox(height: 10),
                                  Container(
                                    alignment: Alignment.centerLeft,
                                    height: 50,
                                  ...
                                  Text("이름 * ", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold ),),
                                  SizedBox(height: 10),
                                  Container(
                                    alignment: Alignment.centerLeft,
                                    height: 50,
